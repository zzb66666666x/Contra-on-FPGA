...
# setting SOPC_SYSID_BASE_ADDRESS is 0x870
SOPC_SYSID_FLAG += --sidp=0x870
ELF_PATCH_FLAG  += --sidp 0x870

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1608276587
SOPC_SYSID_FLAG += --timestamp=1608276587
ELF_PATCH_FLAG  += --timestamp 1608276587
