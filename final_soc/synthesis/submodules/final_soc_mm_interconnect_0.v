...
module final_soc_mm_interconnect_0 (
		...
		input  wire        game_cpu_reset_reset_bridge_in_reset_reset,  //  game_cpu_reset_reset_bridge_in_reset.reset
		...
		input  wire [28:0] game_cpu_data_master_address,                //                  game_cpu_data_master.address
		output wire        game_cpu_data_master_waitrequest,            //                                      .waitrequest
		input  wire [3:0]  game_cpu_data_master_byteenable,             //                                      .byteenable
		input  wire        game_cpu_data_master_read,                   //                                      .read
		output wire [31:0] game_cpu_data_master_readdata,               //                                      .readdata
		input  wire        game_cpu_data_master_write,                  //                                      .write
		input  wire [31:0] game_cpu_data_master_writedata,              //                                      .writedata
		input  wire        game_cpu_data_master_debugaccess,            //                                      .debugaccess
		input  wire [28:0] game_cpu_instruction_master_address,         //           game_cpu_instruction_master.address
		output wire        game_cpu_instruction_master_waitrequest,     //                                      .waitrequest
		input  wire        game_cpu_instruction_master_read,            //                                      .read
		output wire [31:0] game_cpu_instruction_master_readdata,        //                                      .readdata
		output wire [5:0]  avalon_game_interface_avl_address,           //             avalon_game_interface_avl.address
		output wire        avalon_game_interface_avl_write,             //                                      .write
		output wire        avalon_game_interface_avl_read,              //                                      .read
		input  wire [31:0] avalon_game_interface_avl_readdata,          //                                      .readdata
		output wire [31:0] avalon_game_interface_avl_writedata,         //                                      .writedata
		output wire [3:0]  avalon_game_interface_avl_byteenable,        //                                      .byteenable
		output wire        avalon_game_interface_avl_chipselect,        //                                      .chipselect
		output wire [1:0]  frame_sync_s1_address,                       //                         frame_sync_s1.address
		input  wire [31:0] frame_sync_s1_readdata,                      //                                      .readdata
		output wire [8:0]  game_cpu_debug_mem_slave_address,            //              game_cpu_debug_mem_slave.address
		output wire        game_cpu_debug_mem_slave_write,              //                                      .write
		output wire        game_cpu_debug_mem_slave_read,               //                                      .read
		input  wire [31:0] game_cpu_debug_mem_slave_readdata,           //                                      .readdata
		output wire [31:0] game_cpu_debug_mem_slave_writedata,          //                                      .writedata
		output wire [3:0]  game_cpu_debug_mem_slave_byteenable,         //                                      .byteenable
		input  wire        game_cpu_debug_mem_slave_waitrequest,        //                                      .waitrequest
		output wire        game_cpu_debug_mem_slave_debugaccess,        //                                      .debugaccess
	...
	wire          game_cpu_data_master_translator_avalon_universal_master_0_waitrequest;          // game_cpu_data_master_agent:av_waitrequest -> game_cpu_data_master_translator:uav_waitrequest
	wire   [31:0] game_cpu_data_master_translator_avalon_universal_master_0_readdata;             // game_cpu_data_master_agent:av_readdata -> game_cpu_data_master_translator:uav_readdata
	wire          game_cpu_data_master_translator_avalon_universal_master_0_debugaccess;          // game_cpu_data_master_translator:uav_debugaccess -> game_cpu_data_master_agent:av_debugaccess
	wire   [28:0] game_cpu_data_master_translator_avalon_universal_master_0_address;              // game_cpu_data_master_translator:uav_address -> game_cpu_data_master_agent:av_address
	wire          game_cpu_data_master_translator_avalon_universal_master_0_read;                 // game_cpu_data_master_translator:uav_read -> game_cpu_data_master_agent:av_read
	wire    [3:0] game_cpu_data_master_translator_avalon_universal_master_0_byteenable;           // game_cpu_data_master_translator:uav_byteenable -> game_cpu_data_master_agent:av_byteenable
	wire          game_cpu_data_master_translator_avalon_universal_master_0_readdatavalid;        // game_cpu_data_master_agent:av_readdatavalid -> game_cpu_data_master_translator:uav_readdatavalid
	wire          game_cpu_data_master_translator_avalon_universal_master_0_lock;                 // game_cpu_data_master_translator:uav_lock -> game_cpu_data_master_agent:av_lock
	wire          game_cpu_data_master_translator_avalon_universal_master_0_write;                // game_cpu_data_master_translator:uav_write -> game_cpu_data_master_agent:av_write
	wire   [31:0] game_cpu_data_master_translator_avalon_universal_master_0_writedata;            // game_cpu_data_master_translator:uav_writedata -> game_cpu_data_master_agent:av_writedata
	wire    [2:0] game_cpu_data_master_translator_avalon_universal_master_0_burstcount;           // game_cpu_data_master_translator:uav_burstcount -> game_cpu_data_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                              // rsp_mux:src_valid -> game_cpu_data_master_agent:rp_valid
	wire  [106:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> game_cpu_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                              // game_cpu_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [12:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> game_cpu_data_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                      // rsp_mux:src_startofpacket -> game_cpu_data_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                        // rsp_mux:src_endofpacket -> game_cpu_data_master_agent:rp_endofpacket
	wire          game_cpu_instruction_master_translator_avalon_universal_master_0_waitrequest;   // game_cpu_instruction_master_agent:av_waitrequest -> game_cpu_instruction_master_translator:uav_waitrequest
	wire   [31:0] game_cpu_instruction_master_translator_avalon_universal_master_0_readdata;      // game_cpu_instruction_master_agent:av_readdata -> game_cpu_instruction_master_translator:uav_readdata
	wire          game_cpu_instruction_master_translator_avalon_universal_master_0_debugaccess;   // game_cpu_instruction_master_translator:uav_debugaccess -> game_cpu_instruction_master_agent:av_debugaccess
	wire   [28:0] game_cpu_instruction_master_translator_avalon_universal_master_0_address;       // game_cpu_instruction_master_translator:uav_address -> game_cpu_instruction_master_agent:av_address
	wire          game_cpu_instruction_master_translator_avalon_universal_master_0_read;          // game_cpu_instruction_master_translator:uav_read -> game_cpu_instruction_master_agent:av_read
	wire    [3:0] game_cpu_instruction_master_translator_avalon_universal_master_0_byteenable;    // game_cpu_instruction_master_translator:uav_byteenable -> game_cpu_instruction_master_agent:av_byteenable
	wire          game_cpu_instruction_master_translator_avalon_universal_master_0_readdatavalid; // game_cpu_instruction_master_agent:av_readdatavalid -> game_cpu_instruction_master_translator:uav_readdatavalid
	wire          game_cpu_instruction_master_translator_avalon_universal_master_0_lock;          // game_cpu_instruction_master_translator:uav_lock -> game_cpu_instruction_master_agent:av_lock
	wire          game_cpu_instruction_master_translator_avalon_universal_master_0_write;         // game_cpu_instruction_master_translator:uav_write -> game_cpu_instruction_master_agent:av_write
	wire   [31:0] game_cpu_instruction_master_translator_avalon_universal_master_0_writedata;     // game_cpu_instruction_master_translator:uav_writedata -> game_cpu_instruction_master_agent:av_writedata
	wire    [2:0] game_cpu_instruction_master_translator_avalon_universal_master_0_burstcount;    // game_cpu_instruction_master_translator:uav_burstcount -> game_cpu_instruction_master_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                          // rsp_mux_001:src_valid -> game_cpu_instruction_master_agent:rp_valid
	wire  [106:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> game_cpu_instruction_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                          // game_cpu_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [12:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> game_cpu_instruction_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                  // rsp_mux_001:src_startofpacket -> game_cpu_instruction_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                    // rsp_mux_001:src_endofpacket -> game_cpu_instruction_master_agent:rp_endofpacket
	...
	wire   [31:0] avalon_game_interface_avl_agent_m0_readdata;                                    // avalon_game_interface_avl_translator:uav_readdata -> avalon_game_interface_avl_agent:m0_readdata
	wire          avalon_game_interface_avl_agent_m0_waitrequest;                                 // avalon_game_interface_avl_translator:uav_waitrequest -> avalon_game_interface_avl_agent:m0_waitrequest
	wire          avalon_game_interface_avl_agent_m0_debugaccess;                                 // avalon_game_interface_avl_agent:m0_debugaccess -> avalon_game_interface_avl_translator:uav_debugaccess
	wire   [28:0] avalon_game_interface_avl_agent_m0_address;                                     // avalon_game_interface_avl_agent:m0_address -> avalon_game_interface_avl_translator:uav_address
	wire    [3:0] avalon_game_interface_avl_agent_m0_byteenable;                                  // avalon_game_interface_avl_agent:m0_byteenable -> avalon_game_interface_avl_translator:uav_byteenable
	wire          avalon_game_interface_avl_agent_m0_read;                                        // avalon_game_interface_avl_agent:m0_read -> avalon_game_interface_avl_translator:uav_read
	wire          avalon_game_interface_avl_agent_m0_readdatavalid;                               // avalon_game_interface_avl_translator:uav_readdatavalid -> avalon_game_interface_avl_agent:m0_readdatavalid
	wire          avalon_game_interface_avl_agent_m0_lock;                                        // avalon_game_interface_avl_agent:m0_lock -> avalon_game_interface_avl_translator:uav_lock
	wire   [31:0] avalon_game_interface_avl_agent_m0_writedata;                                   // avalon_game_interface_avl_agent:m0_writedata -> avalon_game_interface_avl_translator:uav_writedata
	wire          avalon_game_interface_avl_agent_m0_write;                                       // avalon_game_interface_avl_agent:m0_write -> avalon_game_interface_avl_translator:uav_write
	wire    [2:0] avalon_game_interface_avl_agent_m0_burstcount;                                  // avalon_game_interface_avl_agent:m0_burstcount -> avalon_game_interface_avl_translator:uav_burstcount
	wire          avalon_game_interface_avl_agent_rf_source_valid;                                // avalon_game_interface_avl_agent:rf_source_valid -> avalon_game_interface_avl_agent_rsp_fifo:in_valid
	wire  [107:0] avalon_game_interface_avl_agent_rf_source_data;                                 // avalon_game_interface_avl_agent:rf_source_data -> avalon_game_interface_avl_agent_rsp_fifo:in_data
	wire          avalon_game_interface_avl_agent_rf_source_ready;                                // avalon_game_interface_avl_agent_rsp_fifo:in_ready -> avalon_game_interface_avl_agent:rf_source_ready
	wire          avalon_game_interface_avl_agent_rf_source_startofpacket;                        // avalon_game_interface_avl_agent:rf_source_startofpacket -> avalon_game_interface_avl_agent_rsp_fifo:in_startofpacket
	wire          avalon_game_interface_avl_agent_rf_source_endofpacket;                          // avalon_game_interface_avl_agent:rf_source_endofpacket -> avalon_game_interface_avl_agent_rsp_fifo:in_endofpacket
	wire          avalon_game_interface_avl_agent_rsp_fifo_out_valid;                             // avalon_game_interface_avl_agent_rsp_fifo:out_valid -> avalon_game_interface_avl_agent:rf_sink_valid
	wire  [107:0] avalon_game_interface_avl_agent_rsp_fifo_out_data;                              // avalon_game_interface_avl_agent_rsp_fifo:out_data -> avalon_game_interface_avl_agent:rf_sink_data
	wire          avalon_game_interface_avl_agent_rsp_fifo_out_ready;                             // avalon_game_interface_avl_agent:rf_sink_ready -> avalon_game_interface_avl_agent_rsp_fifo:out_ready
	wire          avalon_game_interface_avl_agent_rsp_fifo_out_startofpacket;                     // avalon_game_interface_avl_agent_rsp_fifo:out_startofpacket -> avalon_game_interface_avl_agent:rf_sink_startofpacket
	wire          avalon_game_interface_avl_agent_rsp_fifo_out_endofpacket;                       // avalon_game_interface_avl_agent_rsp_fifo:out_endofpacket -> avalon_game_interface_avl_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                          // cmd_mux_001:src_valid -> avalon_game_interface_avl_agent:cp_valid
	wire  [106:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> avalon_game_interface_avl_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                          // avalon_game_interface_avl_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [12:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> avalon_game_interface_avl_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                  // cmd_mux_001:src_startofpacket -> avalon_game_interface_avl_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                    // cmd_mux_001:src_endofpacket -> avalon_game_interface_avl_agent:cp_endofpacket
	...
	wire  [106:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire   [31:0] game_cpu_debug_mem_slave_agent_m0_readdata;                                     // game_cpu_debug_mem_slave_translator:uav_readdata -> game_cpu_debug_mem_slave_agent:m0_readdata
	wire          game_cpu_debug_mem_slave_agent_m0_waitrequest;                                  // game_cpu_debug_mem_slave_translator:uav_waitrequest -> game_cpu_debug_mem_slave_agent:m0_waitrequest
	wire          game_cpu_debug_mem_slave_agent_m0_debugaccess;                                  // game_cpu_debug_mem_slave_agent:m0_debugaccess -> game_cpu_debug_mem_slave_translator:uav_debugaccess
	wire   [28:0] game_cpu_debug_mem_slave_agent_m0_address;                                      // game_cpu_debug_mem_slave_agent:m0_address -> game_cpu_debug_mem_slave_translator:uav_address
	wire    [3:0] game_cpu_debug_mem_slave_agent_m0_byteenable;                                   // game_cpu_debug_mem_slave_agent:m0_byteenable -> game_cpu_debug_mem_slave_translator:uav_byteenable
	wire          game_cpu_debug_mem_slave_agent_m0_read;                                         // game_cpu_debug_mem_slave_agent:m0_read -> game_cpu_debug_mem_slave_translator:uav_read
	wire          game_cpu_debug_mem_slave_agent_m0_readdatavalid;                                // game_cpu_debug_mem_slave_translator:uav_readdatavalid -> game_cpu_debug_mem_slave_agent:m0_readdatavalid
	wire          game_cpu_debug_mem_slave_agent_m0_lock;                                         // game_cpu_debug_mem_slave_agent:m0_lock -> game_cpu_debug_mem_slave_translator:uav_lock
	wire   [31:0] game_cpu_debug_mem_slave_agent_m0_writedata;                                    // game_cpu_debug_mem_slave_agent:m0_writedata -> game_cpu_debug_mem_slave_translator:uav_writedata
	wire          game_cpu_debug_mem_slave_agent_m0_write;                                        // game_cpu_debug_mem_slave_agent:m0_write -> game_cpu_debug_mem_slave_translator:uav_write
	wire    [2:0] game_cpu_debug_mem_slave_agent_m0_burstcount;                                   // game_cpu_debug_mem_slave_agent:m0_burstcount -> game_cpu_debug_mem_slave_translator:uav_burstcount
	wire          game_cpu_debug_mem_slave_agent_rf_source_valid;                                 // game_cpu_debug_mem_slave_agent:rf_source_valid -> game_cpu_debug_mem_slave_agent_rsp_fifo:in_valid
	wire  [107:0] game_cpu_debug_mem_slave_agent_rf_source_data;                                  // game_cpu_debug_mem_slave_agent:rf_source_data -> game_cpu_debug_mem_slave_agent_rsp_fifo:in_data
	wire          game_cpu_debug_mem_slave_agent_rf_source_ready;                                 // game_cpu_debug_mem_slave_agent_rsp_fifo:in_ready -> game_cpu_debug_mem_slave_agent:rf_source_ready
	wire          game_cpu_debug_mem_slave_agent_rf_source_startofpacket;                         // game_cpu_debug_mem_slave_agent:rf_source_startofpacket -> game_cpu_debug_mem_slave_agent_rsp_fifo:in_startofpacket
	wire          game_cpu_debug_mem_slave_agent_rf_source_endofpacket;                           // game_cpu_debug_mem_slave_agent:rf_source_endofpacket -> game_cpu_debug_mem_slave_agent_rsp_fifo:in_endofpacket
	wire          game_cpu_debug_mem_slave_agent_rsp_fifo_out_valid;                              // game_cpu_debug_mem_slave_agent_rsp_fifo:out_valid -> game_cpu_debug_mem_slave_agent:rf_sink_valid
	wire  [107:0] game_cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // game_cpu_debug_mem_slave_agent_rsp_fifo:out_data -> game_cpu_debug_mem_slave_agent:rf_sink_data
	wire          game_cpu_debug_mem_slave_agent_rsp_fifo_out_ready;                              // game_cpu_debug_mem_slave_agent:rf_sink_ready -> game_cpu_debug_mem_slave_agent_rsp_fifo:out_ready
	wire          game_cpu_debug_mem_slave_agent_rsp_fifo_out_startofpacket;                      // game_cpu_debug_mem_slave_agent_rsp_fifo:out_startofpacket -> game_cpu_debug_mem_slave_agent:rf_sink_startofpacket
	wire          game_cpu_debug_mem_slave_agent_rsp_fifo_out_endofpacket;                        // game_cpu_debug_mem_slave_agent_rsp_fifo:out_endofpacket -> game_cpu_debug_mem_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_003_src_valid;                                                          // cmd_mux_003:src_valid -> game_cpu_debug_mem_slave_agent:cp_valid
	wire  [106:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> game_cpu_debug_mem_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                          // game_cpu_debug_mem_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [12:0] cmd_mux_003_src_channel;                                                        // cmd_mux_003:src_channel -> game_cpu_debug_mem_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                  // cmd_mux_003:src_startofpacket -> game_cpu_debug_mem_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                    // cmd_mux_003:src_endofpacket -> game_cpu_debug_mem_slave_agent:cp_endofpacket
	...
	wire   [28:0] system_pll_pll_slave_agent_m0_address;                                          // system_pll_pll_slave_agent:m0_address -> system_pll_pll_slave_translator:uav_address
	...
	wire  [107:0] system_pll_pll_slave_agent_rf_source_data;                                      // system_pll_pll_slave_agent:rf_source_data -> system_pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [107:0] system_pll_pll_slave_agent_rsp_fifo_out_data;                                   // system_pll_pll_slave_agent_rsp_fifo:out_data -> system_pll_pll_slave_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> system_pll_pll_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                          // system_pll_pll_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [12:0] cmd_mux_004_src_channel;                                                        // cmd_mux_004:src_channel -> system_pll_pll_slave_agent:cp_channel
	...
	wire   [31:0] frame_sync_s1_agent_m0_readdata;                                                // frame_sync_s1_translator:uav_readdata -> frame_sync_s1_agent:m0_readdata
	wire          frame_sync_s1_agent_m0_waitrequest;                                             // frame_sync_s1_translator:uav_waitrequest -> frame_sync_s1_agent:m0_waitrequest
	wire          frame_sync_s1_agent_m0_debugaccess;                                             // frame_sync_s1_agent:m0_debugaccess -> frame_sync_s1_translator:uav_debugaccess
	wire   [28:0] frame_sync_s1_agent_m0_address;                                                 // frame_sync_s1_agent:m0_address -> frame_sync_s1_translator:uav_address
	wire    [3:0] frame_sync_s1_agent_m0_byteenable;                                              // frame_sync_s1_agent:m0_byteenable -> frame_sync_s1_translator:uav_byteenable
	wire          frame_sync_s1_agent_m0_read;                                                    // frame_sync_s1_agent:m0_read -> frame_sync_s1_translator:uav_read
	wire          frame_sync_s1_agent_m0_readdatavalid;                                           // frame_sync_s1_translator:uav_readdatavalid -> frame_sync_s1_agent:m0_readdatavalid
	wire          frame_sync_s1_agent_m0_lock;                                                    // frame_sync_s1_agent:m0_lock -> frame_sync_s1_translator:uav_lock
	wire   [31:0] frame_sync_s1_agent_m0_writedata;                                               // frame_sync_s1_agent:m0_writedata -> frame_sync_s1_translator:uav_writedata
	wire          frame_sync_s1_agent_m0_write;                                                   // frame_sync_s1_agent:m0_write -> frame_sync_s1_translator:uav_write
	wire    [2:0] frame_sync_s1_agent_m0_burstcount;                                              // frame_sync_s1_agent:m0_burstcount -> frame_sync_s1_translator:uav_burstcount
	wire          frame_sync_s1_agent_rf_source_valid;                                            // frame_sync_s1_agent:rf_source_valid -> frame_sync_s1_agent_rsp_fifo:in_valid
	wire  [107:0] frame_sync_s1_agent_rf_source_data;                                             // frame_sync_s1_agent:rf_source_data -> frame_sync_s1_agent_rsp_fifo:in_data
	wire          frame_sync_s1_agent_rf_source_ready;                                            // frame_sync_s1_agent_rsp_fifo:in_ready -> frame_sync_s1_agent:rf_source_ready
	wire          frame_sync_s1_agent_rf_source_startofpacket;                                    // frame_sync_s1_agent:rf_source_startofpacket -> frame_sync_s1_agent_rsp_fifo:in_startofpacket
	wire          frame_sync_s1_agent_rf_source_endofpacket;                                      // frame_sync_s1_agent:rf_source_endofpacket -> frame_sync_s1_agent_rsp_fifo:in_endofpacket
	wire          frame_sync_s1_agent_rsp_fifo_out_valid;                                         // frame_sync_s1_agent_rsp_fifo:out_valid -> frame_sync_s1_agent:rf_sink_valid
	wire  [107:0] frame_sync_s1_agent_rsp_fifo_out_data;                                          // frame_sync_s1_agent_rsp_fifo:out_data -> frame_sync_s1_agent:rf_sink_data
	wire          frame_sync_s1_agent_rsp_fifo_out_ready;                                         // frame_sync_s1_agent:rf_sink_ready -> frame_sync_s1_agent_rsp_fifo:out_ready
	wire          frame_sync_s1_agent_rsp_fifo_out_startofpacket;                                 // frame_sync_s1_agent_rsp_fifo:out_startofpacket -> frame_sync_s1_agent:rf_sink_startofpacket
	wire          frame_sync_s1_agent_rsp_fifo_out_endofpacket;                                   // frame_sync_s1_agent_rsp_fifo:out_endofpacket -> frame_sync_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_012_src_valid;                                                          // cmd_mux_012:src_valid -> frame_sync_s1_agent:cp_valid
	wire  [106:0] cmd_mux_012_src_data;                                                           // cmd_mux_012:src_data -> frame_sync_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                          // frame_sync_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                        // cmd_mux_012:src_channel -> frame_sync_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                                  // cmd_mux_012:src_startofpacket -> frame_sync_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                    // cmd_mux_012:src_endofpacket -> frame_sync_s1_agent:cp_endofpacket
	wire          game_cpu_data_master_agent_cp_valid;                                            // game_cpu_data_master_agent:cp_valid -> router:sink_valid
	wire  [106:0] game_cpu_data_master_agent_cp_data;                                             // game_cpu_data_master_agent:cp_data -> router:sink_data
	wire          game_cpu_data_master_agent_cp_ready;                                            // router:sink_ready -> game_cpu_data_master_agent:cp_ready
	wire          game_cpu_data_master_agent_cp_startofpacket;                                    // game_cpu_data_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          game_cpu_data_master_agent_cp_endofpacket;                                      // game_cpu_data_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          game_cpu_instruction_master_agent_cp_valid;                                     // game_cpu_instruction_master_agent:cp_valid -> router_001:sink_valid
	wire  [106:0] game_cpu_instruction_master_agent_cp_data;                                      // game_cpu_instruction_master_agent:cp_data -> router_001:sink_data
	wire          game_cpu_instruction_master_agent_cp_ready;                                     // router_001:sink_ready -> game_cpu_instruction_master_agent:cp_ready
	wire          game_cpu_instruction_master_agent_cp_startofpacket;                             // game_cpu_instruction_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          game_cpu_instruction_master_agent_cp_endofpacket;                               // game_cpu_instruction_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire          avalon_game_interface_avl_agent_rp_valid;                                       // avalon_game_interface_avl_agent:rp_valid -> router_003:sink_valid
	wire  [106:0] avalon_game_interface_avl_agent_rp_data;                                        // avalon_game_interface_avl_agent:rp_data -> router_003:sink_data
	wire          avalon_game_interface_avl_agent_rp_ready;                                       // router_003:sink_ready -> avalon_game_interface_avl_agent:rp_ready
	wire          avalon_game_interface_avl_agent_rp_startofpacket;                               // avalon_game_interface_avl_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          avalon_game_interface_avl_agent_rp_endofpacket;                                 // avalon_game_interface_avl_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [106:0] sysid_qsys_control_slave_agent_rp_data;                                         // sysid_qsys_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire          game_cpu_debug_mem_slave_agent_rp_valid;                                        // game_cpu_debug_mem_slave_agent:rp_valid -> router_005:sink_valid
	wire  [106:0] game_cpu_debug_mem_slave_agent_rp_data;                                         // game_cpu_debug_mem_slave_agent:rp_data -> router_005:sink_data
	wire          game_cpu_debug_mem_slave_agent_rp_ready;                                        // router_005:sink_ready -> game_cpu_debug_mem_slave_agent:rp_ready
	wire          game_cpu_debug_mem_slave_agent_rp_startofpacket;                                // game_cpu_debug_mem_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          game_cpu_debug_mem_slave_agent_rp_endofpacket;                                  // game_cpu_debug_mem_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [106:0] system_pll_pll_slave_agent_rp_data;                                             // system_pll_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire          frame_sync_s1_agent_rp_valid;                                                   // frame_sync_s1_agent:rp_valid -> router_014:sink_valid
	wire  [106:0] frame_sync_s1_agent_rp_data;                                                    // frame_sync_s1_agent:rp_data -> router_014:sink_data
	wire          frame_sync_s1_agent_rp_ready;                                                   // router_014:sink_ready -> frame_sync_s1_agent:rp_ready
	wire          frame_sync_s1_agent_rp_startofpacket;                                           // frame_sync_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          frame_sync_s1_agent_rp_endofpacket;                                             // frame_sync_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire   [12:0] cmd_demux_001_src2_channel;                                                     // cmd_demux_001:src2_channel -> crosser_001:in_channel
	...
	wire   [12:0] crosser_003_out_channel;                                                        // crosser_003:out_channel -> rsp_mux_001:sink2_channel
	...
	wire          avalon_game_interface_avl_agent_rdata_fifo_src_valid;                           // avalon_game_interface_avl_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] avalon_game_interface_avl_agent_rdata_fifo_src_data;                            // avalon_game_interface_avl_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          avalon_game_interface_avl_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_001:in_0_ready -> avalon_game_interface_avl_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                              // avalon_st_adapter_001:out_0_valid -> avalon_game_interface_avl_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                               // avalon_st_adapter_001:out_0_data -> avalon_game_interface_avl_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                              // avalon_game_interface_avl_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                              // avalon_st_adapter_001:out_0_error -> avalon_game_interface_avl_agent:rdata_fifo_sink_error
	...
	wire          game_cpu_debug_mem_slave_agent_rdata_fifo_src_valid;                            // game_cpu_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] game_cpu_debug_mem_slave_agent_rdata_fifo_src_data;                             // game_cpu_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          game_cpu_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_003:in_0_ready -> game_cpu_debug_mem_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                              // avalon_st_adapter_003:out_0_valid -> game_cpu_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                               // avalon_st_adapter_003:out_0_data -> game_cpu_debug_mem_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                              // game_cpu_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                              // avalon_st_adapter_003:out_0_error -> game_cpu_debug_mem_slave_agent:rdata_fifo_sink_error
	wire          system_pll_pll_slave_agent_rdata_fifo_src_valid;                                // system_pll_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] system_pll_pll_slave_agent_rdata_fifo_src_data;                                 // system_pll_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          system_pll_pll_slave_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_004:in_0_ready -> system_pll_pll_slave_agent:rdata_fifo_src_ready
	...
	wire          frame_sync_s1_agent_rdata_fifo_src_valid;                                       // frame_sync_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] frame_sync_s1_agent_rdata_fifo_src_data;                                        // frame_sync_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          frame_sync_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_012:in_0_ready -> frame_sync_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                              // avalon_st_adapter_012:out_0_valid -> frame_sync_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                               // avalon_st_adapter_012:out_0_data -> frame_sync_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                              // frame_sync_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                              // avalon_st_adapter_012:out_0_error -> frame_sync_s1_agent:rdata_fifo_sink_error
	...
	) game_cpu_data_master_translator (
		.clk                    (system_clk_clk_clk),                                                      //                       clk.clk
		.reset                  (game_cpu_reset_reset_bridge_in_reset_reset),                              //                     reset.reset
		.uav_address            (game_cpu_data_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (game_cpu_data_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (game_cpu_data_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (game_cpu_data_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (game_cpu_data_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (game_cpu_data_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (game_cpu_data_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (game_cpu_data_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (game_cpu_data_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (game_cpu_data_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (game_cpu_data_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (game_cpu_data_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (game_cpu_data_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (game_cpu_data_master_byteenable),                                         //                          .byteenable
		.av_read                (game_cpu_data_master_read),                                               //                          .read
		.av_readdata            (game_cpu_data_master_readdata),                                           //                          .readdata
		.av_write               (game_cpu_data_master_write),                                              //                          .write
		.av_writedata           (game_cpu_data_master_writedata),                                          //                          .writedata
		.av_debugaccess         (game_cpu_data_master_debugaccess),                                        //                          .debugaccess
	...
	) game_cpu_instruction_master_translator (
		.clk                    (system_clk_clk_clk),                                                             //                       clk.clk
		.reset                  (game_cpu_reset_reset_bridge_in_reset_reset),                                     //                     reset.reset
		.uav_address            (game_cpu_instruction_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (game_cpu_instruction_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (game_cpu_instruction_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (game_cpu_instruction_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (game_cpu_instruction_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (game_cpu_instruction_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (game_cpu_instruction_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (game_cpu_instruction_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (game_cpu_instruction_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (game_cpu_instruction_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (game_cpu_instruction_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (game_cpu_instruction_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (game_cpu_instruction_master_waitrequest),                                        //                          .waitrequest
		.av_read                (game_cpu_instruction_master_read),                                               //                          .read
		.av_readdata            (game_cpu_instruction_master_readdata),                                           //                          .readdata
		.av_burstcount          (1'b1),                                                                           //               (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) avalon_game_interface_avl_translator (
		.clk                    (system_clk_clk_clk),                               //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset),      //                    reset.reset
		.uav_address            (avalon_game_interface_avl_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (avalon_game_interface_avl_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (avalon_game_interface_avl_agent_m0_read),          //                         .read
		.uav_write              (avalon_game_interface_avl_agent_m0_write),         //                         .write
		.uav_waitrequest        (avalon_game_interface_avl_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (avalon_game_interface_avl_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (avalon_game_interface_avl_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (avalon_game_interface_avl_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (avalon_game_interface_avl_agent_m0_writedata),     //                         .writedata
		.uav_lock               (avalon_game_interface_avl_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (avalon_game_interface_avl_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (avalon_game_interface_avl_address),                //      avalon_anti_slave_0.address
		.av_write               (avalon_game_interface_avl_write),                  //                         .write
		.av_read                (avalon_game_interface_avl_read),                   //                         .read
		.av_readdata            (avalon_game_interface_avl_readdata),               //                         .readdata
		.av_writedata           (avalon_game_interface_avl_writedata),              //                         .writedata
		.av_byteenable          (avalon_game_interface_avl_byteenable),             //                         .byteenable
		.av_chipselect          (avalon_game_interface_avl_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
		.av_readdatavalid       (1'b0),                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) game_cpu_debug_mem_slave_translator (
		.clk                    (system_clk_clk_clk),                              //                      clk.clk
		.reset                  (game_cpu_reset_reset_bridge_in_reset_reset),      //                    reset.reset
		.uav_address            (game_cpu_debug_mem_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (game_cpu_debug_mem_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (game_cpu_debug_mem_slave_agent_m0_read),          //                         .read
		.uav_write              (game_cpu_debug_mem_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (game_cpu_debug_mem_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (game_cpu_debug_mem_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (game_cpu_debug_mem_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (game_cpu_debug_mem_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (game_cpu_debug_mem_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (game_cpu_debug_mem_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (game_cpu_debug_mem_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (game_cpu_debug_mem_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (game_cpu_debug_mem_slave_write),                  //                         .write
		.av_read                (game_cpu_debug_mem_slave_read),                   //                         .read
		.av_readdata            (game_cpu_debug_mem_slave_readdata),               //                         .readdata
		.av_writedata           (game_cpu_debug_mem_slave_writedata),              //                         .writedata
		.av_byteenable          (game_cpu_debug_mem_slave_byteenable),             //                         .byteenable
		.av_waitrequest         (game_cpu_debug_mem_slave_waitrequest),            //                         .waitrequest
		.av_debugaccess         (game_cpu_debug_mem_slave_debugaccess),            //                         .debugaccess
		.av_begintransfer       (),                                                //              (terminated)
		.av_beginbursttransfer  (),                                                //              (terminated)
		.av_burstcount          (),                                                //              (terminated)
		.av_readdatavalid       (1'b0),                                            //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) frame_sync_s1_translator (
		.clk                    (system_clk_clk_clk),                          //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (frame_sync_s1_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (frame_sync_s1_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (frame_sync_s1_agent_m0_read),                 //                         .read
		.uav_write              (frame_sync_s1_agent_m0_write),                //                         .write
		.uav_waitrequest        (frame_sync_s1_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (frame_sync_s1_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (frame_sync_s1_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (frame_sync_s1_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (frame_sync_s1_agent_m0_writedata),            //                         .writedata
		.uav_lock               (frame_sync_s1_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (frame_sync_s1_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (frame_sync_s1_address),                       //      avalon_anti_slave_0.address
		.av_readdata            (frame_sync_s1_readdata),                      //                         .readdata
		.av_write               (),                                            //              (terminated)
		.av_read                (),                                            //              (terminated)
		.av_writedata           (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) game_cpu_data_master_agent (
		.clk                   (system_clk_clk_clk),                                                      //       clk.clk
		.reset                 (game_cpu_reset_reset_bridge_in_reset_reset),                              // clk_reset.reset
		.av_address            (game_cpu_data_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (game_cpu_data_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (game_cpu_data_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (game_cpu_data_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (game_cpu_data_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (game_cpu_data_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (game_cpu_data_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (game_cpu_data_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (game_cpu_data_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (game_cpu_data_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (game_cpu_data_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (game_cpu_data_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (game_cpu_data_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (game_cpu_data_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (game_cpu_data_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (game_cpu_data_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) game_cpu_instruction_master_agent (
		.clk                   (system_clk_clk_clk),                                                             //       clk.clk
		.reset                 (game_cpu_reset_reset_bridge_in_reset_reset),                                     // clk_reset.reset
		.av_address            (game_cpu_instruction_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (game_cpu_instruction_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (game_cpu_instruction_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (game_cpu_instruction_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (game_cpu_instruction_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (game_cpu_instruction_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (game_cpu_instruction_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (game_cpu_instruction_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (game_cpu_instruction_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (game_cpu_instruction_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (game_cpu_instruction_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (game_cpu_instruction_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (game_cpu_instruction_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (game_cpu_instruction_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (game_cpu_instruction_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (game_cpu_instruction_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) avalon_game_interface_avl_agent (
		.clk                     (system_clk_clk_clk),                                         //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset),                //       clk_reset.reset
		.m0_address              (avalon_game_interface_avl_agent_m0_address),                 //              m0.address
		.m0_burstcount           (avalon_game_interface_avl_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (avalon_game_interface_avl_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (avalon_game_interface_avl_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (avalon_game_interface_avl_agent_m0_lock),                    //                .lock
		.m0_readdata             (avalon_game_interface_avl_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (avalon_game_interface_avl_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (avalon_game_interface_avl_agent_m0_read),                    //                .read
		.m0_waitrequest          (avalon_game_interface_avl_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (avalon_game_interface_avl_agent_m0_writedata),               //                .writedata
		.m0_write                (avalon_game_interface_avl_agent_m0_write),                   //                .write
		.rp_endofpacket          (avalon_game_interface_avl_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (avalon_game_interface_avl_agent_rp_ready),                   //                .ready
		.rp_valid                (avalon_game_interface_avl_agent_rp_valid),                   //                .valid
		.rp_data                 (avalon_game_interface_avl_agent_rp_data),                    //                .data
		.rp_startofpacket        (avalon_game_interface_avl_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (avalon_game_interface_avl_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (avalon_game_interface_avl_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (avalon_game_interface_avl_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (avalon_game_interface_avl_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (avalon_game_interface_avl_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (avalon_game_interface_avl_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (avalon_game_interface_avl_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (avalon_game_interface_avl_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (avalon_game_interface_avl_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (avalon_game_interface_avl_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                          //                .error
		.rdata_fifo_src_ready    (avalon_game_interface_avl_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (avalon_game_interface_avl_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (avalon_game_interface_avl_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) avalon_game_interface_avl_agent_rsp_fifo (
		.clk               (system_clk_clk_clk),                                         //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		.in_data           (avalon_game_interface_avl_agent_rf_source_data),             //        in.data
		.in_valid          (avalon_game_interface_avl_agent_rf_source_valid),            //          .valid
		.in_ready          (avalon_game_interface_avl_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (avalon_game_interface_avl_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (avalon_game_interface_avl_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (avalon_game_interface_avl_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (avalon_game_interface_avl_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (avalon_game_interface_avl_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (avalon_game_interface_avl_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (avalon_game_interface_avl_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                      // (terminated)
		.csr_read          (1'b0),                                                       // (terminated)
		.csr_write         (1'b0),                                                       // (terminated)
		.csr_readdata      (),                                                           // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) game_cpu_debug_mem_slave_agent (
		.clk                     (system_clk_clk_clk),                                        //             clk.clk
		.reset                   (game_cpu_reset_reset_bridge_in_reset_reset),                //       clk_reset.reset
		.m0_address              (game_cpu_debug_mem_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (game_cpu_debug_mem_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (game_cpu_debug_mem_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (game_cpu_debug_mem_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (game_cpu_debug_mem_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (game_cpu_debug_mem_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (game_cpu_debug_mem_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (game_cpu_debug_mem_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (game_cpu_debug_mem_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (game_cpu_debug_mem_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (game_cpu_debug_mem_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (game_cpu_debug_mem_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (game_cpu_debug_mem_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (game_cpu_debug_mem_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (game_cpu_debug_mem_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (game_cpu_debug_mem_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (game_cpu_debug_mem_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (game_cpu_debug_mem_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (game_cpu_debug_mem_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (game_cpu_debug_mem_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (game_cpu_debug_mem_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (game_cpu_debug_mem_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (game_cpu_debug_mem_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (game_cpu_debug_mem_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (game_cpu_debug_mem_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (game_cpu_debug_mem_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (game_cpu_debug_mem_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (game_cpu_debug_mem_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (game_cpu_debug_mem_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) game_cpu_debug_mem_slave_agent_rsp_fifo (
		.clk               (system_clk_clk_clk),                                        //       clk.clk
		.reset             (game_cpu_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		.in_data           (game_cpu_debug_mem_slave_agent_rf_source_data),             //        in.data
		.in_valid          (game_cpu_debug_mem_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (game_cpu_debug_mem_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (game_cpu_debug_mem_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (game_cpu_debug_mem_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (game_cpu_debug_mem_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (game_cpu_debug_mem_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (game_cpu_debug_mem_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (game_cpu_debug_mem_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (game_cpu_debug_mem_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (system_clk_clk_clk),                             //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset),    //       clk_reset.reset
		.m0_address              (frame_sync_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (frame_sync_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (frame_sync_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (frame_sync_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (frame_sync_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (frame_sync_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (frame_sync_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (frame_sync_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (frame_sync_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (frame_sync_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (frame_sync_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (frame_sync_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (frame_sync_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (frame_sync_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (frame_sync_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (frame_sync_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (frame_sync_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (frame_sync_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (frame_sync_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (frame_sync_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (frame_sync_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (frame_sync_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (frame_sync_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (frame_sync_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (frame_sync_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (frame_sync_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_012_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_012_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_012_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_012_out_0_error),              //                .error
		.rdata_fifo_src_ready    (frame_sync_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (frame_sync_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (frame_sync_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) frame_sync_s1_agent_rsp_fifo (
		.clk               (system_clk_clk_clk),                             //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (frame_sync_s1_agent_rf_source_data),             //        in.data
		.in_valid          (frame_sync_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (frame_sync_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (frame_sync_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (frame_sync_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (frame_sync_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (frame_sync_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (frame_sync_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (frame_sync_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (frame_sync_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	final_soc_mm_interconnect_0_router router (
		.sink_ready         (game_cpu_data_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (game_cpu_data_master_agent_cp_valid),         //          .valid
		.sink_data          (game_cpu_data_master_agent_cp_data),          //          .data
		.sink_startofpacket (game_cpu_data_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (game_cpu_data_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (system_clk_clk_clk),                          //       clk.clk
		.reset              (game_cpu_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	final_soc_mm_interconnect_0_router_001 router_001 (
		.sink_ready         (game_cpu_instruction_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (game_cpu_instruction_master_agent_cp_valid),         //          .valid
		.sink_data          (game_cpu_instruction_master_agent_cp_data),          //          .data
		.sink_startofpacket (game_cpu_instruction_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (game_cpu_instruction_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (system_clk_clk_clk),                                 //       clk.clk
		.reset              (game_cpu_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
	...
	final_soc_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (avalon_game_interface_avl_agent_rp_ready),         //      sink.ready
		.sink_valid         (avalon_game_interface_avl_agent_rp_valid),         //          .valid
		.sink_data          (avalon_game_interface_avl_agent_rp_data),          //          .data
		.sink_startofpacket (avalon_game_interface_avl_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (avalon_game_interface_avl_agent_rp_endofpacket),   //          .endofpacket
		.clk                (system_clk_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	final_soc_mm_interconnect_0_router_005 router_005 (
		.sink_ready         (game_cpu_debug_mem_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (game_cpu_debug_mem_slave_agent_rp_valid),         //          .valid
		.sink_data          (game_cpu_debug_mem_slave_agent_rp_data),          //          .data
		.sink_startofpacket (game_cpu_debug_mem_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (game_cpu_debug_mem_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (system_clk_clk_clk),                              //       clk.clk
		.reset              (game_cpu_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	final_soc_mm_interconnect_0_router_002 router_014 (
		.sink_ready         (frame_sync_s1_agent_rp_ready),                //      sink.ready
		.sink_valid         (frame_sync_s1_agent_rp_valid),                //          .valid
		.sink_data          (frame_sync_s1_agent_rp_data),                 //          .data
		.sink_startofpacket (frame_sync_s1_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (frame_sync_s1_agent_rp_endofpacket),          //          .endofpacket
		.clk                (system_clk_clk_clk),                          //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (system_clk_clk_clk),                         //       clk.clk
		.reset               (game_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (system_clk_clk_clk),                          //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_soc_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (system_pll_c0_clk),                       //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (system_clk_clk_clk),                         //       clk.clk
		.reset              (game_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (system_clk_clk_clk),                          //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	final_soc_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (system_pll_c0_clk),                       //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (game_cpu_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (game_cpu_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	final_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (system_clk_clk_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset),          // in_rst_0.reset
		.in_0_data      (avalon_game_interface_avl_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (avalon_game_interface_avl_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (avalon_game_interface_avl_agent_rdata_fifo_src_ready), //         .ready
	...
	final_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (system_clk_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (game_cpu_reset_reset_bridge_in_reset_reset),          // in_rst_0.reset
		.in_0_data      (game_cpu_debug_mem_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (game_cpu_debug_mem_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (game_cpu_debug_mem_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	final_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (system_clk_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset),     // in_rst_0.reset
		.in_0_data      (system_pll_pll_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (system_pll_pll_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (system_pll_pll_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	final_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (system_clk_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (frame_sync_s1_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (frame_sync_s1_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (frame_sync_s1_agent_rdata_fifo_src_ready),    //         .ready
